            ...
            <TableBody>
                {
                    patients.map(patient => {
                        return <TableRow key={patient.id}>
                            ...
                            <TableCell>{patient.admission_date.toLocaleDateString("es-Mx")}</TableCell>
                            <TableCell>{patient.mechanical_ventilation ? "Si" : "No"}</TableCell>
                            <TableCell>{patient.exitus_letalis ? "Si" : "No"}</TableCell>
                            <TableCell>{patient.discharged ? "Si" : "No"}</TableCell>
                            <TableCell>{patient.discharge_date?.toISOString() ?? "-"}</TableCell>
                        </TableRow>
                    })
                }
            </TableBody>
