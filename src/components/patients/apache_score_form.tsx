...
import { CreateFollowupNoteSchema } from "~/data/schemas";
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <Input type="number" placeholder="potencial de hidrógeno" {...field} />
                    </FormControl>
                    <FormMessage />
                </FormItem>
            )}
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <Input type="number" placeholder="pulsaciones por minuto" {...field} />
                    </FormControl>
                    <FormMessage />
                </FormItem>
            )}
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl>
                        <Input type="number" placeholder="respiraciones por minuto" {...field} />
                    </FormControl>
                    <FormMessage />
                </FormItem>
            )}
