...
function calculate_creatinine_score(
	creatinine: number,
	acute: boolean,
	chronic: boolean,
): number {
	switch (true) {
		case creatinine >= 3.5 && acute:
			return 8;
		case creatinine >= 2.0 && creatinine < 3.5 && acute:
			return 6;
		case creatinine >= 3.5 && chronic:
			return 4;
		case creatinine >= 1.5 && creatinine < 2.0 && acute:
			return 4;
		case creatinine >= 2.0 && creatinine < 3.5 && chronic:
			return 3;
		case creatinine >= 1.5 && creatinine < 2.0 && chronic:
			return 2;
		case creatinine >= 0.6 && creatinine < 1.5:
			return 0;
		default:
			return 2;
	}
...
function calculate_hematocritic_score(hematocritic: number): number {
	switch (true) {
		case hematocritic >= 60:
			return 4;
		case hematocritic >= 50 && hematocritic < 60:
			return 2;
		case hematocritic >= 46 && hematocritic < 50:
			return 1;
		case hematocritic >= 30 && hematocritic < 46:
			return 0;
		case hematocritic >= 20 && hematocritic < 30:
			return 2;
		default:
			return 4;
	}
...
function calculate_white_cell_score(cells: number): number {
	switch (true) {
		case cells >= 40:
			return 4;
		case cells >= 20 && cells < 40:
			return 2;
		case cells >= 15 && cells < 20:
			return 1;
		case cells >= 3 && cells < 15:
			return 0;
		case cells >= 1 && cells < 3:
			return 2;
		default:
			return 4;
	}
...
export function calculate_apache_score(form: ApacheScoreForm): number {
	...
	const creatinine_score = calculate_creatinine_score(
		form.creatinine,
		form.acute_renal_failure || false,
		form.chronic_renal_failure || false,
	);
...
export function get_survival_percentage(
	apache_score: number,
	is_postoperative = false,
): number {
	switch (true) {
		case apache_score <= 4:
			return is_postoperative ? 99 : 96;
		case apache_score <= 9:
			return is_postoperative ? 97 : 92;
		case apache_score <= 14:
			return is_postoperative ? 93 : 85;
		case apache_score <= 19:
			return is_postoperative ? 88 : 75;
		case apache_score <= 24:
			return is_postoperative ? 70 : 60;
		case apache_score <= 29:
			return is_postoperative ? 65 : 45;
		case apache_score <= 34:
			return is_postoperative ? 27 : 27;
		default:
			return is_postoperative ? 12 : 15;
	}
}
